...
interface MangaTerminalCardProps {
  manga: Manga;
  index: number;
  /** Override the accent strip class (default: status-based color) */
  accentColor?: string;
  /** Override the title text class (default: status-based textClass) */
  titleClass?: string;
...
export function MangaTerminalCard({
  manga,
  index,
  accentColor,
  titleClass,
  ...
  const isGhost = showGhost && status === "not-downloaded";
